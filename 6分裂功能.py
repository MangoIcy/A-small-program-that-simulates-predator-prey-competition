...
initial_predator_counter = 5  # 初始predator数量/个
initial_prey_counter = 10  # 初始prey数量/个

predator_circle_radius = 1  # predator半径
prey_circle_radius = 1  # prey半径

predator_max_fasting_time = 10  # 捕食者最长空腹时间
predator_max_life = 50  # 捕食者寿命/秒

prey_split_time = 2  # prey分裂时间/s
...
while True:
    ...
    for key in keys_to_delete:  # 统一删除键
        ...
        counter_predator -= counter_predator
