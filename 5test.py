...
max_predator_counter = 10  # 最大predator数量/个
max_prey_counter = 100  # 最大prey数量/个

predator_circle_radius = 10  # predator半径
prey_circle_radius = 10  # prey半径

predator_max_fasting_time = 10  # 捕食者最长空腹时间
predator_max_life = 100  # 捕食者寿命/秒
...
while True:
    ...
    if counter_predator < max_predator_counter:
        ...
        predator = Predator(red, predator_circle_radius)
    ...
    if counter_prey < max_prey_counter:
        ...
        prey = Prey(green, prey_circle_radius)
